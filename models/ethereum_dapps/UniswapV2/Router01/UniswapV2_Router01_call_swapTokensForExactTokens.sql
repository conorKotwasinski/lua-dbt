...
{% set contract_name = "Router01" %}
{% set abi_name = "swapTokensForExactTokens" %}
{% set abi_inputs = ["to", "path", "amountInMax", "amountOut", "deadline"] %}
...
select
    ...
    lower(to) as to,
    lower(path) as path,
    toUInt256(amountInMax) as amountInMax,
    toUInt256(amountOut) as amountOut,
